...
uset As we noted in the [introduction](#Introduction), this row shows us that the question is "What's your age?". We know we are expecting a numeric input by looking at the `input_type` column, and the default value is equal to 25 according to the `option` column.
